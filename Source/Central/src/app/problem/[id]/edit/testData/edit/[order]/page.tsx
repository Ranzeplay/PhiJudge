...
export default function Page({
  ...
  useEffect(() => {
    FetchOriginalData(parseInt(params.id), parseInt(params.order)).then(
      (data) => {
    ...
    <>
      <Card>
        ...
        <CardContent className='space-y-2'>
          ...
          />
          <Button
            onClick={() => UpdateLimits(testDataId, timeLimit!, memoryLimit!)}
          >
            Update
          </Button>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className='space-y-2'>
          ...
          />
          <Button onClick={() => UpdateInputData(testDataId, inputData)}>
            Update
          </Button>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent className='space-y-2'>
          ...
          <Button
            onClick={() =>
              UpdateExpectedOutputData(testDataId, expectedOutputData)
            }
          >
            Update
          </Button>
